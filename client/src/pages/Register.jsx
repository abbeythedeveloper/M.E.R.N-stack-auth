...
const Register = () => {
  ...
  return (
    <div className="container flex flex-row mx-auto mt-5 md:mt-16 space-x-32 h-[500px] justify-between">
    ...
    <div className="mt-5"> 
      ...
      <form onSubmit={handleSubmit} className="flex flex-col mt-8 mr-4">
        ...
        <input className="text-slate-500 border mt-2 border-[#8692A6] bg-[#282A2F] active:border-[#5871EB] duration-300 mb-4 w-full h-10 rounded-md pl-3" type='text' placeholder='enter name....' value={data.name} onChange={(e) => setData({...data, name: e.target.value})}/>
